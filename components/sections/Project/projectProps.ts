...
export const projectsData: ProjectProps[] = [
  ...
  },
  {
    ...
    // },
    description:
      "Oekakusa ( お絵描草, meaning drawing grass ) is a desktop application that tracks your illustration progress in CLIP STUDIO PAINT (.clip) and visualizes it as a GitHub-style contribution graph. It turns every save into a commit, helping you maintain motivation by filling up the graph. Features include automatic .clip file tracking, thumbnail extraction, contribution graph, GIF export, fibonacci spiral detection, color analysis, and more.",
    techstacks: [
      "React",
      "Firebase",
      "Rust Tauri",
  ...
  },
  {
    ...
    // },
    description:
      "A web application that analyzes images to detect and visualize Fibonacci spirals in compositions. The app identifies key points in an image using contour detection, clusters them, and fits a logarithmic spiral that approximates the golden ratio. ",
